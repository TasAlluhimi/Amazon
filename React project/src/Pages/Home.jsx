...
<form>
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        <div class="relative w-full">
            ...
            type="search" 
            class="block p-2.5 w-96 max-sm:w-72 z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search for city or address" required/>
...
<div id="carouselExample" class="carousel slide relative mt-3">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://m.media-amazon.com/images/I/717RUPA1bDL._SX3000_.jpg" class="d-block w-100" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="https://m.media-amazon.com/images/I/61lwJy4B8PL._SX3000_.jpg" class="d-block w-100" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="https://m.media-amazon.com/images/I/71Ie3JXGfVL._SX3000_.jpg" class="d-block w-100" alt="..."/>
      
      {/* <div className='absolute text-9xl top-96 z-10 flex flex-wrap'>
        {data.map((item)=>(
...
<div className='absolute top-96 z-10 flex justify-center items-center flex-wrap gap-5 mt-20'>

{filtered.length < 0 ? 
<div className='text-xl z-10'>No result found</div>
:
filtered.map((item)=>(
    <div className='bg-white w-80 h-[25rem] p-3 gap-4 flex flex-col justify-center items-center
    hover:scale-105'
    key={item.id}>
        <div className='self-start text-sm'>{item.title}</div>
        <div><img src={item.image} 
        className='w-40 '
        alt={item.title} 
        /></div>
        <Link to={`/More/${item.id}`}><div className='self-start hover:text-blue-700'>See more</div></Link>
    </div>
))
}
        </div>
